# Bitter Lesson Cleanup â€” Implementation Plan

> **For Claude:** REQUIRED SUB-SKILL: Use superpowers:executing-plans to implement this plan task-by-task.

**Goal:** Clean up garden-bot v0.1.0 repo to align with the skills' lean, Bitter-Lesson-informed philosophy.

**Architecture:** 7 independent cleanup tasks executed sequentially, one commit each. No code logic changes â€” only file deletions, renames, and small text edits.
...
- Architecture section (update paths: `docs/` â†’ `dev/`)
...
- landscape-design REFACTOR â€” Final Status
- Environment section
- Web search note
...
### Task 4: Reorganize repo â€” `docs/` â†’ `dev/`
...
Expected:
```
docs/plans/active/2026-02-16-garden-bot-design.md
docs/plans/active/2026-02-16-garden-bot-implementation.md
docs/plans/archive/2026-02-18-bitter-lesson-cleanup-design.md
docs/plans/archive/2026-02-18-bitter-lesson-cleanup-implementation.md
docs/plans/archive/2026-02-18-bitter-lesson-review.md
docs/testing/results/archive/garden-expert-baseline.md
docs/testing/results/archive/garden-profile-baseline.md
docs/testing/results/archive/integration-results.md
docs/testing/results/archive/landscape-design-baseline.md
docs/testing/results/archive/landscape-design-refactor-analysis.md
docs/testing/results/archive/scenario2-baseline-garden-log.md
...
**Files:**
- Modify: `docs/plans/active/2026-02-16-garden-bot-design.md` (line 1)
- Modify: `docs/plans/active/2026-02-16-garden-bot-implementation.md` (line 1)

**Step 1: Add header to design doc**

Prepend to `docs/plans/active/2026-02-16-garden-bot-design.md`:
```markdown
> **Historical document** â€” reflects what was planned, not what shipped. Key deviations: ASCII replaced SVG, reference files never needed, CWD replaced ~/garden-bot/, MPL-2.0 replaced MIT, manual testing replaced subagent testing. See shipped skills for actual implementation.
...
Prepend same header to `docs/plans/active/2026-02-16-garden-bot-implementation.md`.
...
```bash
git add docs/plans/active/2026-02-16-garden-bot-design.md docs/plans/active/2026-02-16-garden-bot-implementation.md
...
Change:
```
If web search returns no results, fetch extension service pages directly (e.g. `extension.oregonstate.edu/gardening/vegetables`). Only cite URLs you actually retrieved successfully â€” never guess at URLs in your citations.
```

To:
```
If web search returns no results, fetch extension service pages directly. Only cite URLs you actually retrieved successfully â€” never guess at URLs in your citations.
```
